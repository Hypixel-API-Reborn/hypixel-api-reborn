...
import { SKYWARS_CONSTANT_LEVELING_XP, SKYWARS_CONSTANT_XP_TO_NEXT_LEVEL, SKYWARS_LEVEL_MAX, SKYWARS_TOTAL_XP, SKYWARS_XP_TO_NEXT_LEVEL } from "../../../Utils/Constants.js";
...
class SkyWars extends SkyWarsMode {
    ...
    static getLevel(xp) {
        if (xp >= SKYWARS_CONSTANT_LEVELING_XP) {
            const level = Math.floor((xp - SKYWARS_CONSTANT_LEVELING_XP) / SKYWARS_CONSTANT_XP_TO_NEXT_LEVEL) +
...
//# sourceMappingURL=SkyWars.js.map