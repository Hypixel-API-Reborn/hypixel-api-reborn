...
declare module "hypixel-api-reborn" {
	...
	class GameCounts {
		...
		skyblock: {
			players: number;
			modes: { dungeonHub: number; mining_2: number; farming_2: number; farming_1: number; mining_3: number; combat_3: number; dynamic: number; combat_1: number; foraging_1: number; hub: number; dungeon: number; combat_2: number; mining_1: number };
		};
