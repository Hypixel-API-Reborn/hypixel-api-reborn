...
export const MiningForgeQuickForgeMultiplier = {
    0: 1,
    1: 0.895,
    2: 0.89,
    3: 0.885,
...
export const magicalPowerValues = {
    COMMON: 3,
    UNCOMMON: 5,
    RARE: 8,
    EPIC: 12,
...
export const CustomPetLeveling = {
    GOLDEN_DRAGON: {
        type: 1,
        petLevels: [
...
export const HOTF_XP = { 1: 0, 2: 3000, 3: 9000, 4: 25000, 5: 60000, 6: 100000, 7: 150000 };
...
export const BestiaryMobs = {
    ...
    farming_1: {
        ...
        mobs: [
            ...
            { name: '§aCow', cap: 200, mobs: ['farming_cow_1'], bracket: 1 },
            { name: '§aMushroom Cow', cap: 200, mobs: ['mushroom_cow_1'], bracket: 1 },
            { name: '§aPig', cap: 200, mobs: ['farming_pig_1'], bracket: 1 },
            { name: '§aRabbit', cap: 200, mobs: ['farming_rabbit_1'], bracket: 1 },
...
export const BuildBattleTitleRequirements = [
...
export const BedWarsPrestigeRequirements = [
...
export const SKYWARS_TOTAL_XP = SKYWARS_XP_TO_NEXT_LEVEL.map((_, index) => SKYWARS_XP_TO_NEXT_LEVEL.slice(0, index + 1).reduce((acc, xp) => acc + xp, 0));
