...
class BuildBattle {
    ...
    constructor(data) {
        ...
        this.emblem = new Emblem(data?.emblem || {});
    ...
    static getBuildBattleTitle(score) {
        return ((BuildBattleTitleRequirements.slice()
            .reverse()
            .find((t) => score >= t.requirement) || BuildBattleTitleRequirements[0])?.title || 'Rookie');
    }
}
export default BuildBattle;
//# sourceMappingURL=BuildBattle.js.map