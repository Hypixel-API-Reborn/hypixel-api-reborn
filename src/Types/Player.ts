...
export type BlitzSurvivalGamesKitId =
  | 'arachnologist'
  | 'archer'
  | 'armorer'
  | 'astronaut'
  ...
  | 'warrior'
  | 'wolftamer';
export type BlitzSurvivalGamesKitName =
  | 'Arachnologist'
  | 'Archer'
  | 'Armorer'
  | 'Astronaut'
  ...
  | 'Warrior'
  | 'Wolftamer';
export type BlitzSurvivalGamesAura =
  | 'BLUE_PARTICLE'
  | 'DAYLIGHT_PARTICLE'
  | 'DRAGON_EGG_PARTICLE'
  | 'DUST_PARTICLE'
  ...
  | 'WATER_PARTICLE'
  | 'WHEAT_TRAIL';
export type BlitzSurvivalGamesTaunt =
  | 'DEFAULT'
  | 'BAT_DUDE'
  | 'CHICKEN_DANCE'
  | 'COOKIE'
  ...
  | 'VILLAGER_MUSIC_BAND'
  | 'WOLF_PACK';
export type BlitzSurvivalGamesVictoryDance =
  | 'BLAZING_SPEED'
  ...
  | 'METEOR_SHOWER'
  | 'PLAYER_FIREWORK';
export type BlitzSurvivalGamesFinisher =
  | 'CREEPER_FIREWORK'
  | 'EXPLOSIONS'
  | 'GRAVESTONE'
  | 'INFESTATION'
  ...
  | 'REKT_HOLOGRAM'
  | 'SQUID_MISSILE';
export type BlitzSurvivalGamesKillEffect = 'gravedigger' | 'random' | 'rapid_fire' | 'regeneration' | 'resistance';
export type BlitzSurvivalGamesLeaderboardSettingsMode = 'ALL_MODES' | 'SOLO' | 'TEAMS';
export type BlitzSurvivalGamesPrivateGamesExtraStars =
  | '1 Star - Normal'
  | '2 Stars'
  | '3 Stars'
  | '4 Stars'
