...
class SkyBlockMemberPlayerStats {
    ...
    constructor(data) {
        ...
        this.kills = {
            total: Object.values(data?.kills || {}).reduce((acc, curr) => acc + curr, 0),
        ...
        this.deaths = {
            total: Object.values(data?.deaths || {}).reduce((acc, curr) => acc + curr, 0),
...
//# sourceMappingURL=SkyBlockMemberPlayerStats.js.map