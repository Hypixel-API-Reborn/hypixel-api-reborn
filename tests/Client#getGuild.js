...
describe('Client#getGuild', async () => {
  ...
  describe('Valid', async () => {
    ...
    describe('Guild 2', async () => {
      describe('Guild Name', async () => {
        it('expect not to throw', async () => {
          guildName = await client.getGuild('name', 'WristSpasm');
        });
        it('should be an object', () => {
          expect(guildName).to.be.an('object');
        });
      ...
      describe('Guild Id', async () => {
        it('expect not to throw', async () => {
          guildId = await client.getGuild('id', '5b8dd8cb0cf24573ab84c9ad');
        });
        it('should be an object', () => {
          expect(guildId).to.be.an('object');
        });
      ...
      describe('Guild Player', async () => {
        it('expect not to throw', async () => {
          guildPlayer = await client.getGuild('player', '2700c8b565c74d8e9be5eb7a6ae19295');
        });
        it('should be an object', () => {
          expect(guildPlayer).to.be.an('object');
        });
    ...
    describe('Guild 3', async () => {
      describe('Guild Name', async () => {
        it('expect not to throw', async () => {
          guildName = await client.getGuild('name', 'Felony');
        });
        it('should be an object', () => {
          expect(guildName).to.be.an('object');
        });
      ...
      describe('Guild Id', async () => {
        it('expect not to throw', async () => {
          guildId = await client.getGuild('id', '5fc50e9a8ea8c9d1008d5f86');
        });
        it('should be an object', () => {
          expect(guildId).to.be.an('object');
        });
      ...
      describe('Guild Player', async () => {
        it('expect not to throw', async () => {
          guildPlayer = await client.getGuild('player', '1dddfc8a54604b39b84d3ec4f2a1dcbe');
        });
        it('should be an object', () => {
          expect(guildPlayer).to.be.an('object');
        });
